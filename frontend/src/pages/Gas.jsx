  ...
  return (
    <div className="shop-product-page">
      <div className="container py-5">
        ...
        <p className="shop-sub-text">
          Scientifically backed aquaculture solutions
        </p>

        {/* SEARCH + FILTER (same Shop UI) */}
