...
import img4 from "../assets/images/reno-fast-1.jpg";
...
const images = [
  ...
  { src: img4, name: "RENO FAST" },
  { src: img5, name: "MEDISAN" },
];

function Disease_Kit_1() {
  ...
  const kitProduct = {
    category: "Kit",
    name: "Disease Control Kit_1",
    image: img1,
    size: ["Full Kit"],
    price: ["3315"],
    desc: "Disease Control Kit_1",
  };
    ...
    <div className="kitWrapper">
      <div className="kitContainer">
        ...
        <div className="kitRight">
          ...
          <h1 className="title">Disease Control Kit_1</h1>

          <p className="subText">
            Fish bimar hai___ turant solution
          </p>
